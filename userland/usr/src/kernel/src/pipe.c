/*
 * pipe.c -- implementation of pipes
 */
...
Bool debugPlock = FALSE;
Bool debugPrele = FALSE;
...
void pipe(void) {
	...
	u.u_r.r_val.r_val2 = u.u_r.r_val.r_val1;
	u.u_r.r_val.r_val1 = r;
