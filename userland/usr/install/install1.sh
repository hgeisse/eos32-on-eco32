...
echo "# A T T E N T I O N" >> disk.part
echo "# please make sure that the new eos32 root partition has the type 0x58 and is bootable!" >> disk.part
echo "## Step 1.4: Please modify the partition file (disk.part)."
joe ./disk.part
echo "## Step 1.5: Write new partition table to disk..."
mkpart /dev/idedisk ./disk.part
echo ""
echo "## Step 1.6: Please write down the numbers for each partition to the next"
echo "install file (install2.sh)."
echo "After this, please R-E-B-O-O-T the entire system!"
sync