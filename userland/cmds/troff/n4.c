...
void setn1(int i);
int findr(int i);
int fnumb(int i, int (*f)(int));
int decml(int i, int (*f)(int));
int roman(int i, int (*f)(int));
int roman0(int i, int (*f)(int), char *onesp, char *fivesp);
int abc(int i, int (*f)(int));
int abc0(int i, int (*f)(int));
int wrc(int i);
int _atoi(void);
long atoi0(void);
long ckph(void);
